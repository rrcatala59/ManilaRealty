...
const properties = [
  ...
  },
  {
    ...
    images: [
      ...
      unsplash("photo-1600585154340-0ef3ce59a0b9"),
      unsplash("photo-1600607687644-c7171b42498b"),
      unsplash("photo-1600047509807-ba8b95fda5c7"),
    ],
    status: PropertyStatus.AVAILABLE,
    isAvailable: true,
    isFeatured: true,
  ...
  },
  {
    ...
    images: [
      ...
      unsplash("photo-1600210492493-94ba31e4e1ea"),
    ],
    status: PropertyStatus.AVAILABLE,
    isAvailable: true,
    isFeatured: true,
  },
  {
    ...
    images: [
      ...
      unsplash("photo-1600585152220-90363fe30d49"),
    ],
    status: PropertyStatus.AVAILABLE,
    isAvailable: true,
    isFeatured: false,
  },
  {
    ...
    lng: 121.0366,
    images: [
      unsplash("photo-1600047509358-9dc7550a0c8e"),
      unsplash("photo-1600607687920-4e2a09cf159d"),
      unsplash("photo-1600573472550-8090b5e0745a"),
  ...
  },
  {
    ...
    lng: 121.0412,
    images: [
      unsplash("photo-1613490493576-7fde63d32aaa"),
      unsplash("photo-1600596542815-ffad4c1539a9"),
      unsplash("photo-1600585154526-990dced4db0d"),
      unsplash("photo-1600607687644-c7171b42498b"),
    ],

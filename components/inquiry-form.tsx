  ...
  return (
    <form action={action} className="space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        <Input id="name" name="name" required className="h-11 rounded-sm" />
      </div>
      <div className="space-y-1.5">
        <Label htmlFor="email">Email</Label>
        <Input id="email" name="email" type="email" required className="h-11 rounded-sm" />
      </div>
      <div className="space-y-1.5">
        <Label htmlFor="phone">Phone</Label>
        <Input id="phone" name="phone" required className="h-11 rounded-sm" placeholder="+63" />
      </div>
      <div className="space-y-1.5">
